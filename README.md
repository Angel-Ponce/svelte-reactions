...
| `labelReaction` | number | Same as `reaction` property, this define the reaction representation on summary labels (by default this value is equal to provided `reaction` value |
